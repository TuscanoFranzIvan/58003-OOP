...
#widgets start from here
        ...
        self.btnadd = Button(win,text="Add", fg = "Black",command = self.sub)
        self.btnadd.place(x=100,y=200)
        self.btnadd.bind('<Button-1>',self.add)
        self.btnsub = Button(win,text="Subtract", fg = "Black",command = self.sub)
        self.btnsub.place(x=150,y=200)
        self.btnmul = Button(win,text="Multiply",fg = "Black",command = self.mul)
        self.btnmul.place(x=220,y=200)
        self.btndiv = Button(win,text="Divide",fg = "Black",command = self.div)
        self.btndiv.place(x=290,y=200)
